(function($){
	$.cometChat = {
        ...
        members:function(message) {
            var sb = [];
            sb[sb.length] = "<table>";
        	sb[sb.length] = "</br><tr><td>Online Users</td></tr><tr><td></td></tr><tr><td></td></tr><tr><td></td></tr></br>";
            $.each(message.data, function() {
            	if ($.cometChat.loginUserName == this) { //login user
            		sb[sb.length] = "<tr><td><span style=\";color: #000000;\"> <img src=\"images/user.png\" alt=\"You\" height=\"15\" width=\"15\"\> " + this + "</span><br></td></tr><tr></tr></br></br><tr></tr>";
            	} else { //peer users
            		sb[sb.length] = "<tr><td><span onclick=\"javascript:createWindow('" + $.cometChat.loginUserName + "', '" + this + "');\"  style=\"cursor: pointer;color: #0000FF;\"> <img src=\"images/guser.png\" alt=\"You\" height=\"15\" width=\"15\"\> " + this + "</span><br></td></tr>";
            	}
            });
            sb[sb.length] = "</table>";
